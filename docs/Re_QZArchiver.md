...
`roj.archive.sevenz` 模块提供了一套用于处理 7z 档案的强大工具，旨在实现多线程、高性能的压缩和解压操作。

*   **读取 7z 档案：** 使用 `roj.archive.sevenz.SevenZFile`
*   **写入 7z 档案：** 使用 `roj.archive.sevenz.SevenZPacker`
...
建议通过类 `roj.gui.impl.SevenZArchiverUI` 尝试本模块的强大功能。
