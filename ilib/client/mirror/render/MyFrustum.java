...
public class MyFrustum implements ICamera {
    private final Vec4f[] frustum;
    private final AxisAlignedBB portalBB;
    ...
    public boolean isBoundingBoxInFrustum(AxisAlignedBB bb) {
        ...
        double sx = MathUtils.clamp(pos.x, bb.minX, bb.maxX),
                sy = MathUtils.clamp(pos.y, bb.minY, bb.maxY),
                sz = MathUtils.clamp(pos.z, bb.minZ, bb.maxZ);
