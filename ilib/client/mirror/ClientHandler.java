...
public class ClientHandler {
    ...
    public static WorldClient createWorld(int dimensionId) {
        ...
        w = new WorldClient(mc.getConnection(),
                            new WorldSettings(0, GameType.SURVIVAL, false, false, WorldType.DEFAULT),
                            dimensionId, EnumDifficulty.NORMAL, mc.profiler);
        worlds.put(dimensionId, w);
        return w;
    }
