...
public class GuiMock extends GuiBaseNI implements ComponentListener {
    ...
    protected void addComponents() {
        ...
        components.add(new GButtonNP(this, 0, 0, "保存").setMark(1).setListener(pp));
        components.add(new GButtonNP(this, 0, 0, "模组").setMark(2).setListener(pp));
        components.add(new GButtonNP(this, 0, 0, "???").setMark(3).setListener(pp));
        components.add(new GButtonNP(this, 0, 0, "数据包").setMark(7).setListener(pp));
    ...
    public void getDynamicTooltip(Component c, List<String> tooltip, int mouseX, int mouseY) {
        switch (c.getMark()) {
            ...
            case 4:
                ...
                break;
            case 5:
                tooltip.add("自动更新客户端为服务器版本");
                tooltip.add("自动更新客户端mod为服务器mod (WIP)");
                break;
            case 6:
                tooltip.add("显示自己是forge客户端");
                break;
            case 7:
