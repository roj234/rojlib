        ...
        if (action == BUTTON_CLICKED) {
            switch (c.getMark()) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    GPopup popup = addPopup("输入名字", "",
                             Collections.singletonList("保存"), 10);
    ...
    private static class SavedPackets extends GScrollView implements ComponentListener {
        ...
        public void actionPerformed(Component c, int action) {
            ...
            if (id >= 0) {
                ...
                switch (c.getMark()) {
                    case 1:
                        ClientProxy.mc.displayGuiScreen(new GuiEditPA(ClientProxy.mc.currentScreen,
                                                                      rulePacketAdapters.get(id)));
                        break;
                    case 2:
