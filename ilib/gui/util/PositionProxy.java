...
public class PositionProxy extends CListenerAdapter {
    ...
    private int type, marginBegin, marginEnd, marginComponent;
    private IntMap<PositionInfo> position = new IntMap<>();
        ...
        switch (type) {
            ...
            case POSITION_FLEX_X: {
                ...
                for (PositionInfo info : position.values()) {
                    ...
                    if (list == null) by.put(c.getYPos(), list = new SimpleList<>(4));
                    list.add(c);
                }
            ...
            case POSITION_FLEX_Y: {
                ...
                for (PositionInfo info : position.values()) {
                    ...
                    if (list == null) by.put(c.getXPos(), list = new SimpleList<>(4));
                    list.add(c);
                }
