...
public enum DefaultSprites implements Sprite {
    ...
    SLOT(87, 173, 18, 18),
    SLOT_OUTPUT(41, 0, 26, 26),

    L_BTN(15, 0, 14, 22),
    L_BTN_HL(15, 22, 14, 22),

    R_BTN(27, 0, 14, 22),
    R_BTN_HL(27, 22, 14, 22),

    UP_BTN(0, 24, 14, 8),
    UP_BTN_HL(0, 32, 14, 8),

    TOGGLE_BTN(67, 0, 32, 14),
    TOGGLE_BTN_HL(67, 14, 32, 14),
    TOGGLE_BTN_ON(67, 28, 32, 14),
    TOGGLE_BTN_ON_HL(67, 42, 32, 14),

    PROGRESS(115, 36, 22, 15),
    PROGRESS_OVERLAY(137, 36, 22, 16),

    FIRE(53, 26, 14, 14),
    FIRE_OVERLAY(53, 40, 14, 14),

    MY_FLUID_BACKGROUND(50, 62, 18, 54),
    MY_FLUID_FOREGROUND(69, 64, 14, 50, 2, 2),

    MY_BACKGROUND(52, 64, 14, 50),
    MY_WATER_BACKGROUND(84, 65, 12, 48, 1, 1),
    MY_WATER_FOREGROUND(97, 65, 12, 48, 1, 1),
    MY_FLUX_BACKGROUND(110, 65, 12, 48, 1, 1),
    MY_FLUX_FOREGROUND(123, 65, 12, 48, 1, 1),

    OLD_FLUID_FOREGROUND(34, 55, 18, 61),
    OLD_ME_BACKGROUND(0, 52, 18, 64),
    OLD_ME_BAR(18, 54, 16, 62, 1, 1),

    DARK_SLOT(14, 116, 18, 18),
    DARK_SLOT_OUTPUT(51, 116, 28, 28),
    ;
     ...
     */
    public static final NinePatchRenderer
            BUTTON_A = new NinePatchRenderer(0, 0, 2, TEXTURE),
            BUTTON_B = new NinePatchRenderer(99, 0, 2, 6, TEXTURE);
