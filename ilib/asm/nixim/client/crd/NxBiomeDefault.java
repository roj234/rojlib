...
class NxBiomeDefault extends Biome {
    ...
    public int getWaterColorMultiplier() {
        ...
        if (event == null) event = new BiomeEvent.GetWaterColor(this, waterColor);
        else MCReplaces.get().setEvent(event, this, waterColor);
    ...
    public int getModdedBiomeGrassColor(int original) {
        ...
        if (event == null) event = new BiomeEvent.GetGrassColor(this, original);
        else MCReplaces.get().setEvent(event, this, original);
        MinecraftForge.EVENT_BUS.post(event);
        int color = event.getNewColor();
        inst.recycle(event);
        return color;
    ...
    public int getModdedBiomeFoliageColor(int original) {
        ...
        if (event == null) event = new BiomeEvent.GetFoliageColor(this, original);
        else MCReplaces.get().setEvent(event, this, original);
        MinecraftForge.EVENT_BUS.post(event);
        int color = event.getNewColor();
        inst.recycle(event);
