...
public class ScrollDown {
    ...
    private boolean tick() {
        ...
        Vec3d pos = EntityHelper.vec(p).sub(center).normalize();

        Vec3d spin = new Vec3d(0,1,0).cross(pos).mul(SPIN_SPEED);
        ...
        Vec3d dest = center.add(pos.mul(radius)).add(spin).add(0, p.motionY, 0);
