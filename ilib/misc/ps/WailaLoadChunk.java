...
public class WailaLoadChunk extends Cheat {
    ...
    public void onCommand(EntityPlayerSP player, String[] args) {
        ...
        buf.writeByte(1).writeInt(Integer.parseInt(args[2]))
           .writeLong(new BlockPos(Integer.parseInt(args[3]), Integer.parseInt(args[4]), Integer.parseInt(args[5])).toLong()).writeInt(0);
