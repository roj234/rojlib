...
public class LoottableBuilder {
	...
	static SerializerFactory ser = SerializerFactoryFactory.create(SerializerFactory.GENERATE| SerializerFactory.CHECK_INTERFACE| SerializerFactory.CHECK_PARENT);
