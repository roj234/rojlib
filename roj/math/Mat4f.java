...
public class Mat4f implements Cloneable {
	 ...
	 */
	public Mat4f(float a11, float a12, float a13, float a14, float a21, float a22, float a23, float a24, float a31, float a32, float a33, float a34, float a41, float a42, float a43, float a44) {
	 ...
	 * @return this matrix.
	 */
	public Mat4f set(float a11, float a12, float a13, float a14, float a21, float a22, float a23, float a24, float a31, float a32, float a33, float a34, float a41, float a42, float a43, float a44) {
	 ...
	 * @return this matrix.
	 */
	public Mat4f makeLookInDirection(Vector eye, Vector dir, Vector up) {
		double abs = Math.sqrt(dir.dot(dir, 3));
		...
		return this.translate(-(float) eye.x(), -(float) eye.y(), -(float) eye.z());
	}
	...
	public float det() {
		...
		return m00 * (m11 * d6 - m12 * d5 + m13 * d4) - m01 * (m10 * d6 - m12 * d3 + m13 * d2) + m02 * (m10 * d5 - m11 * d3 + m13 * d1) - m03 * (m10 * d4 - m11 * d2 + m12 * d1);
	}
	...
	public Vec4f mul(Vec4f v, Vec4f to) {
		...
		return to.set(m00 * x + m01 * y + m02 * z + m03 * w, m10 * x + m11 * y + m12 * z + m13 * w, m20 * x + m21 * y + m22 * z + m23 * w, m30 * x + m31 * y + m32 * z + m33 * w);
	}
	...
	public Vec3f mul(Vec3f v, Vec3f to) {
		...
		return to.set(m00 * x + m01 * y + m02 * z, m10 * x + m11 * y + m12 * z, m20 * x + m21 * y + m22 * z);
	}
	...
	public Mat4f invertGeneral() {
		...
		float[] tmp = {m11 * d10d15 - m21 * d06d15 + m31 * d06d11, -m01 * d10d15 + m21 * d02d15 - m31 * d02d11, m01 * d06d15 - m11 * d02d15 + m31 * d02d07, -m01 * d06d11 + m11 * d02d11 - m21 * d02d07,
					   -m10 * d10d15 + m20 * d06d15 - m30 * d06d11, m00 * d10d15 - m20 * d02d15 + m30 * d02d11, -m00 * d06d15 + m10 * d02d15 - m30 * d02d07, m00 * d06d11 - m10 * d02d11 + m20 * d02d07,
					   m10 * d09d15 - m20 * d05d15 + m30 * d05d11, -m00 * d09d15 + m20 * d01d15 - m30 * d01d11, m00 * d05d15 - m10 * d01d15 + m30 * d01d07, -m00 * d05d11 + m10 * d01d11 - m20 * d01d07,
					   -m10 * d09d14 + m20 * d05d14 - m30 * d05d10, m00 * d09d14 - m20 * d01d14 + m30 * d01d10, -m00 * d05d14 + m10 * d01d14 - m30 * d01d06,
	...
	@Override
	public int hashCode() {
		return new Hasher().add(m00).add(m01).add(m02).add(m03).add(m10).add(m11).add(m12).add(m13).add(m20).add(m21).add(m22).add(m23).add(m30).add(m31).add(m32).add(m33).getHash();
	}
