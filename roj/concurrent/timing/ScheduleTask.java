...
public class ScheduleTask implements ITask {
	...
	Scheduler owner;
	volatile ScheduleTask next;

	private static final long u_nextRun = ReflectionUtils.fieldOffset(ScheduleTask.class, "nextRun");
	...
	public ScheduleTask(ITask task, int interval, int delay, int count) {
