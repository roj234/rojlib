 ...
 */
public final class Poly1305 extends MessageDigest implements MSSSign {
    ...
    final MutableBigInteger
        R = new MutableBigInteger(),
        S = new MutableBigInteger(),
        Tmp = new MutableBigInteger();
    ...
    public void setKey(byte[] key) {
        if (key.length < 32) throw new IllegalStateException("Poly1305 requires 256 bits of key");
        ...
        i = T[E  ];T[E  ] = T[E+3];T[E+3] = i;
        i = T[E+2];T[E+2] = T[E+1];T[E+1] = i;
        R.setValue(T, 4);
    ...
    final void _digest(ByteList in) {
        int[] TI = iBuf;
        TI[4] = in.readIntLE();TI[3] = in.readIntLE();
        TI[2] = in.readIntLE();TI[1] = in.readIntLE();
        TI[0] = 0x01;
    ...
    final void _digestFinal(ByteList in, ByteList out) {
        ...
        while (in.remaining() >= 16) _digest(in);
        if (in.hasRemaining()) {
            byte[] TB = this.bBuf;
            int r = in.remaining();
            in.read(TB, 0, r);
