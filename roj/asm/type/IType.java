...
public interface IType extends java.lang.reflect.Type, Cloneable {
	...
	//default void getTypeParamPart(BiConsumer<IType, TypeParam> params) {}
	default IType resolveTypeParam(Map<String, IType> visualType, Map<String, List<IType>> bounds) { return this; }
