...
public class BasicBlock2 {
	...
	public void chainUpdate(MyHashSet<BasicBlock2> passed, SimpleList<BasicBlock2> route, Var2[] initS) {
	...
	private void comeFrom(SimpleList<BasicBlock2> route, Var2[] initS) {
		int size = Math.max(localMax, initS.length);
		for (int i = 0; i < route.size(); i++) {
			BasicBlock2 p = route.get(i);
