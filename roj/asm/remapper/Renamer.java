...
import roj.asm.cst.*;
import roj.asm.remapper.struct.AttrCode_Simple;
import roj.asm.remapper.struct.AttrLVT_Simple;
...
public final class Renamer extends Mapping {
    public static final boolean DEBUG = Boolean.parseBoolean(System.getProperty("fmd.debugRename", "false"));
    ...
    private static final boolean REPLACE_DESC = Boolean.parseBoolean(System.getProperty("fmd.replaceDesc", "false"));

    private Map<String, ?> paramMap = null;
    private byte paramMapType;
    ...
    final String mapEntryName(ConstantData data, String methodDesc, AttrLVT_Simple.V entry, int i) {
        ...
        switch (paramMapType) {
            case 0:
                break;
            case 1:
                Object name1 = paramMap.get(name);
                if(name1 != null)
                    return name1.toString();
                break;
            case 2:
            case 3:
                Map<String, List<String>> remapNames = (Map<String, List<String>>) paramMap.get(data.name);
                if(remapNames != null) {
                    List<String> vars = remapNames.get(methodDesc);
                    int j = paramMapType == 2 ? i : entry.slot;
        ...
        if(name.length() == 0 || !validVarChars.contains(name.charAt(0))) {
            return "_lvt_" + i + "_";
        }
        return name;
    }
    ...
    public void setParamRemapping(Map<String, String> paramMap) {
        ...
        this.paramMapType = (byte) (paramMap == null ? 0 : 1);
    }
    ...
    public void setParamRemappingV1(Map<String, Map<String, List<String>>> paramMap) {
        this.paramMap = paramMap;
        this.paramMapType = (byte) (paramMap == null ? 0 : 2);
    }
    ...
    public void setParamRemappingV2(Map<String, Map<String, List<String>>> paramMap) {
        this.paramMap = paramMap;
        this.paramMapType = (byte) (paramMap == null ? 0 : 3);
    }
}