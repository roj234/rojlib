 ...
 */
public enum ASTCode {
    GET_OBJECT, PUT_OBJECT, // 属性(Object)
    ADD_ARRAY, // 数组 []=
    INVOKE_FUNCTION, INVOKE_FUNC_NORET, INVOKE_NEW, INSTANCE_OF, // 函数
    POP, DUP, DUP2, DUP2_2, // 栈
    IF, GOTO, RETURN, RETURN_EMPTY, // 流程控制
    SWITCH_INT, SWITCH_STRING, // 选择
    ...
    TRY_ENTER, TRY_EXIT,
    LABEL, // GOTO的目标
    REGION, LINE, LOAD_ARGUMENT, SWAP, THROW, // 技术性
    LOAD_CONTEXT;
}
