...
//            }
    ...
    public static void preDraw(VertexFormat.Entry attr, int stride, ByteBuffer data) {
        int count = attr.elementCount();
        int type = attr.glType();
        switch (attr.usage()) {
            case POS:
    ...
    public static void drawVertexes(int mode, VertexBuilder vb) {
