...
public class OpenGLDebug {
	public static final class GLproperty {
		...
		public final String name, description, category, fetchCommand;
	}

	public static final GLproperty[] properties = {new GLproperty(GL11.GL_CURRENT_COLOR, "GL_CURRENT_COLOR", "Current color", "current", "glGetFloatv()"),
												   ...
												   new GLproperty(GL11.GL_CURRENT_RASTER_TEXTURE_COORDS, "GL_CURRENT_RASTER_TEXTURE_COORDS", "Texture coordinates associated with raster position",
																  "current", "glGetFloatv()"),
												   ...
												   new GLproperty(GL11.GL_VERTEX_ARRAY_STRIDE, "GL_VERTEX_ARRAY_STRIDE", "Stride between verticesBlock", "vertex-array", "glGetIntegerv()"),
												   ...
												   new GLproperty(GL11.GL_TEXTURE_COORD_ARRAY_SIZE, "GL_TEXTURE_COORD_ARRAY_SIZE", "Texture coordinates per element", "vertex-array",
																  "glGetIntegerv()"),
												   ...
												   new GLproperty(GL11.GL_TEXTURE_COORD_ARRAY_STRIDE, "GL_TEXTURE_COORD_ARRAY_STRIDE", "Stride between texture coordinates", "vertex-array",
																  "glGetIntegerv()"),
												   new GLproperty(GL11.GL_TEXTURE_COORD_ARRAY_POINTER, "GL_TEXTURE_COORD_ARRAY_POINTER", "Pointer to the texture coordinate array", "vertex-array",
																  "glGetPointerv()"),
												   ...
												   new GLproperty(GL11.GL_COLOR_MATERIAL_PARAMETER, "GL_COLOR_MATERIAL_PARAMETER", "Material properties tracking current color", "lighting",
																  "glGetIntegerv()"),
												   ...
												   new GLproperty(GL11.GL_POLYGON_OFFSET_POINT, "GL_POLYGON_OFFSET_POINT", "Polygon offset enable for GL_POINT mode rasterization", "polygon/enable",
																  "glIsEnabled()"),
												   new GLproperty(GL11.GL_POLYGON_OFFSET_LINE, "GL_POLYGON_OFFSET_LINE", "Polygon offset enable for GL_LINE mode rasterization", "polygon/enable",
																  "glIsEnabled()"),
												   new GLproperty(GL11.GL_POLYGON_OFFSET_FILL, "GL_POLYGON_OFFSET_FILL", "Polygon offset enable for GL_FILL mode rasterization", "polygon/enable",
																  "glIsEnabled()"),
												   ...
												   new GLproperty(GL11.GL_STENCIL_PASS_DEPTH_FAIL, "GL_STENCIL_PASS_DEPTH_FAIL", "Stencil depth buffer fail action", "stencil-buffer",
																  "glGetIntegerv()"),
												   new GLproperty(GL11.GL_STENCIL_PASS_DEPTH_PASS, "GL_STENCIL_PASS_DEPTH_PASS", "Stencil depth buffer pass action", "stencil-buffer",
																  "glGetIntegerv()"),
												   ...
												   new GLproperty(GL11.GL_MAX_MODELVIEW_STACK_DEPTH, "GL_MAX_MODELVIEW_STACK_DEPTH", "Maximum modelview-matrix stack depth", "capability",
																  "glGetIntegerv()"),
												   new GLproperty(GL11.GL_MAX_PROJECTION_STACK_DEPTH, "GL_MAX_PROJECTION_STACK_DEPTH", "Maximum projection-matrix stack depth", "capability",
																  "glGetIntegerv()"),
												   new GLproperty(GL11.GL_MAX_TEXTURE_STACK_DEPTH, "GL_MAX_TEXTURE_STACK_DEPTH", "Maximum depth of texture matrix stack", "capability",
																  "glGetIntegerv()"),
												   ...
												   new GLproperty(GL11.GL_MAX_PIXEL_MAP_TABLE, "GL_MAX_PIXEL_MAP_TABLE", "Maximum size of a glPixelMap() translation table", "capability",
																  "glGetIntegerv()"),
												   ...
												   new GLproperty(GL11.GL_MAX_CLIENT_ATTRIB_STACK_DEPTH, "GL_MAX_CLIENT_ATTRIB_STACK_DEPTH", "Maximum depth of the client attribute stack",
												   ...
												   new GLproperty(GL11.GL_ACCUM_RED_BITS, "GL_ACCUM_RED_BITS", "Number of bits per red component in the accumulation buffer", "capability",
																  "glGetIntegerv()"),
												   new GLproperty(GL11.GL_ACCUM_GREEN_BITS, "GL_ACCUM_GREEN_BITS", "Number of bits per green component in the accumulation buffer", "capability",
																  "glGetIntegerv()"),
												   new GLproperty(GL11.GL_ACCUM_BLUE_BITS, "GL_ACCUM_BLUE_BITS", "Number of bits per blue component in the accumulation buffer", "capability",
																  "glGetIntegerv()"),
												   new GLproperty(GL11.GL_ACCUM_ALPHA_BITS, "GL_ACCUM_ALPHA_BITS", "Number of bits per alpha component in the accumulation buffer", "capability",
																  "glGetIntegerv()"), new GLproperty(GL11.GL_LIST_BASE, "GL_LIST_BASE", "Setting of glListBase()", "list", "glGetIntegerv()"),
	...
	public static String[] dumpStrings() {
	...
	private static final ByteBuffer buf = BufferUtils.createByteBuffer(16);

	private static void getPropertyAsString(int propertyListIndex, CharList sb) {
		int gLconstant = properties[propertyListIndex].gLconstant;
		switch (properties[propertyListIndex].fetchCommand) {
			case "glIsEnabled()":
				sb.append(GL11.glIsEnabled(gLconstant));
				return;
			case "glGetBooleanv()": {
				GL11.glGetBoolean(gLconstant, buf);
				for (int i = 0; i < buf.capacity(); ++i) {
					sb.append(i == 0 ? ' ' : ',').append(buf.get(i));
				}
				return;
			}
			case "glGetFloatv()":
				sb.append(GL11.glGetFloat(gLconstant));
				return;
			case "glGetIntegerv()":
				sb.append(GL11.glGetInteger(gLconstant));
				return;
			case "glGetPointerv()":
				sb.append(toBytes(GL11.glGetPointer(gLconstant, 16)));
				return;
                /*
            case "glGetLightfv()":    { return "").append(GL11.glGetLightfv()); break;}
            case "glGetMapfv()":    { return "").append(GL11.glGetMapfv()); break;}
            case "glGetMapiv()":    { return "").append(GL11.glGetMapiv()); break;}
            case "glGetMaterialfv()":    { return "").append(GL11.glGetMaterialfv()); break;}
            case "glGetPixelMap*()":    { return "").append(GL11.glGetPixelMap*()); break;}
            case "glGetTexEnvfv()":    { return "").append(GL11.glGetTexEnvfv()); break;}
            case "glGetTexEnviv()":    { return "").append(GL11.glGetTexEnviv()); break;}
            case "glGetTexGenfv()":    { return "").append(GL11.glGetTexGenfv()); break;}
            case "glGetTexGeniv()":    { return "").append(GL11.glGetTexGeniv()); break;}
            case "glGetTexImage()":    { return "").append(GL11.glGetTexImage()); break;}
            case "glGetTexLevelParameter*()":    { return "").append(GL11.glGetTexLevelParameter*()); break;}
            case "glGetTexParameter*()":    { return "").append(GL11.glGetTexParameter*()); break;}
            case "glGetTexParameteriv()":    { return "").append(GL11.glGetTexParameteriv()); break;}*/
			default:
				sb.append("不支持的getter");
		}
	}

	private static String toBytes(ByteBuffer pointer) {
		byte[] buf = new byte[pointer.capacity()];
		pointer.get(buf);
		return TextUtil.dumpBytes(buf);
	}
}
