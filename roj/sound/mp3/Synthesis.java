...
final class Synthesis {
	 ...
	 */
	public Synthesis(AudioBuffer buf, int channels) {
		this.buf = buf;
	...
	public static final int[][] u_vector = {{0, 96, 128, 224, 256, 352, 384, 480, 512, 608, 640, 736, 768, 864, 896, 992},
	...
	public void synthesisSubBand(float[] samples, int ch) {
		...
		if ((findex[ch] & 63) != 0) {
			throw new IllegalStateException("Invalid pcm buf");
		}
