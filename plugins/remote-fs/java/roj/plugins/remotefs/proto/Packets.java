...
public interface Packets {
    PacketHandler SERIALIZER = new PacketHandler(ClientPacket.class, ServerPacket.class)
    ...
    final class Fail implements ServerPacket, ClientPacket {
        ...
        public void handle(RemoteFSClient client) throws IOException {client.onFail(message);}
    ...
    class FileMetadata implements ClientPacket {
        ...
        public void handle(RemoteFSClient client) {client.handleFileMeta(this);}
    }
    final class DirectoryMeta extends FileMetadata {
        ...
        public void handle(RemoteFSClient client) {client.handleDirectoryContent(this);}
    }
    ...
    final class FileHandle implements ClientPacket, ServerPacket {
        ...
        public FileHandle(DynByteBuf buf) {handle = XDataInput.zag(buf.readVUInt());length = buf.readVULong();}
        public void encode(DynByteBuf buf) {buf.putVUInt(DynByteBuf.zig(handle)).putVULong(length);}

        public void handle(RemoteFSClient client) {client.onOpenHandle(this);}
    ...
    final class FileData implements ClientPacket, ServerPacket {
        ...
        public void handle(RemoteFSClient client) throws IOException {client.onFileData(this);}
    ...
    final class AccessToken implements ClientPacket, ServerPacket {
        ...
        public void handle(RemoteFSClient client) throws IOException {client.onLogin(accessToken);}
