...
public final class fcgiConnection implements ChannelHandler, Consumer<MyChannel> {
	...
	private static final VarHandle RESPONSE = Telescope.lookup().findVarHandle(fcgiConnection.class, "activeResponse", fcgiContent.class);
	...
	final int attach(fcgiContent resp, Map<String, String> param) throws Exception {
