 ...
 */
@SevenZCodecExtension("0303011b")
public final class BCJ2 extends SevenZMultiStreamCodec {
	private static final byte[] id = {3,3,1,0x1b};
	public static final BCJ2 INSTANCE = new BCJ2();

	private int fileSize;

	private BCJ2() {register(this);}
	public BCJ2(int fileSize) { this.fileSize = fileSize; }

	public byte[] id() {return id;}

	public int getInCount() {return 4;}
	public int getOutCount() {return 1;}

	@SuppressWarnings("IOResourceOpenedButNotSafelyClosed")
	public OutputStream[] encodeMulti(OutputStream[] out) {return new OutputStream[] { new Encoder(out[0], out[1], out[2], out[3], fileSize) };}

	@SuppressWarnings("IOResourceOpenedButNotSafelyClosed")
	public InputStream[] decodeMulti(InputStream[] in, long[] uncompressedSize, int sizeBegin, AtomicInteger memoryLimit) throws IOException {
		checkMemoryUsage(memoryLimit, 10);
