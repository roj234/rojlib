package roj.archive.sevenz.bcj;
 ...
 */
public abstract class Filter extends RCipher {
	...
	public final void init(boolean flags, byte[] key, AlgorithmParameterSpec config, SecureRandom random) {}
