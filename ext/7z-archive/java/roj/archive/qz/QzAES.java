...
public final class QzAES extends QZCoder {
    ...
    public OutputStream encode(OutputStream out) throws IOException {
        ...
        try {
            cip.init(RCipher.ENCRYPT_MODE, null, new IvParameterSpecNC(iv), null);
        } catch (Exception e) {
            Helpers.athrow(e);
        }
    ...
    public InputStream decode(InputStream in, byte[] key, long uncompressedSize, AtomicInteger memoryLimit) throws IOException {
        ...
        try {
            cip.init(RCipher.DECRYPT_MODE, null, new IvParameterSpecNC(iv), null);
        } catch (Exception e) {
            Helpers.athrow(e);
        }
    ...
    private final RCipher aes = CryptoFactory.AES();
    private void init(byte[] key) {
        ...
        try {
            aes.init(RCipher.DECRYPT_MODE, realKey);
        } catch (Exception e) {
            Helpers.athrow(e);
        }
    }
