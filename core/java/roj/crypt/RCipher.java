...
public abstract class RCipher extends CipherSpi {
	...
	static Cipher _toJavaCipher(RCipher spi) { return new Cipher(spi, CryptoFactory.getInstance(), spi.getAlgorithm()) {}; }
	...
	public RCipher copyWith(boolean isEncryptMode) {throw new UnsupportedOperationException();}
