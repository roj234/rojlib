...
public final class CstFloat extends Constant {
	...
	public final int hashCode() {return Float.floatToRawIntBits(value) * 0x94D049BB;}
	public final boolean equals(Object o) {
		if (o == this) return true;
		return o instanceof CstFloat n && Float.floatToRawIntBits(n.value) == Float.floatToRawIntBits(value);
	}
}