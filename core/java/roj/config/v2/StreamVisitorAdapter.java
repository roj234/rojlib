...
public class StreamVisitorAdapter {
	public static void accept(StreamParser2 parser, CVisitor visitor) throws ParseException, IOException {
	...
	StreamVisitorAdapter(StreamParser2 parser, CVisitor visitor) {
		this.parser = parser;
