 ...
 */
public final class StringValue extends ConfigValue implements Comparable<ConfigValue> {
	public String value;
	StringValue(String string) {value = string.toString();}

	public Type getType() {return Type.STRING;}
	protected boolean eqVal(ConfigValue o) {return o.asString().equals(value);}
	@Override
	...
	public CharList toJSON(CharList sb, int depth) { return Tokenizer.escape(sb.append('"'), value).append('"'); }
	...
	public int compareTo(@NotNull ConfigValue o) {return value.compareTo(o.asString());}
}