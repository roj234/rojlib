 ...
 */
public final class DoubleValue extends ConfigValue {
	public double value;
	public DoubleValue() {}
	public DoubleValue(double number) {this.value = number;}
	public static ConfigValue valueOf(String number) {return valueOf(Double.parseDouble(number));}

	public Type getType() { return Type.DOUBLE; }
	public boolean eqVal(ConfigValue o) { return Double.compare(value, o.asDouble()) == 0; }
