...
public enum ConfigMaster {
	...
	public CVisitor serializer(Object out, String indent) throws IOException {
		if (ordinal() > MSGPACK.ordinal()) {
			...
			switch (this) {
				case JSON, YAML, INI -> {
					TextWriter tw = out instanceof File f ? TextWriter.to(f) : new TextWriter((Closeable) out, null);
	 ...
	 */
	public BinaryParser parser(boolean visitorMode, @MagicConstant(flags = Flags.COMMENT) int initFlag) {
		return switch (this) {
			case JSON -> visitorMode ? new StreamJson(initFlag) : new JSONParser(initFlag);
			case YAML -> visitorMode ? new StreamYaml(initFlag) : new YAMLParser(initFlag);
	...
	public void writeObject(Object o, File file) throws IOException { writeObject((Serializer<Object>) SerializerFactory.SAFE_SERIALIZE_ONLY.serializer(o.getClass()), o, file); }
	@SuppressWarnings("unchecked")
	public void writeObject(Object o, File file, String indent) throws IOException {writeObject((Serializer<Object>) SerializerFactory.SAFE_SERIALIZE_ONLY.serializer(o.getClass()), o, file, indent); }
	@SuppressWarnings("unchecked")
	public void writeObject(Object o, OutputStream out) throws IOException { writeObject((Serializer<Object>) SerializerFactory.SAFE_SERIALIZE_ONLY.serializer(o.getClass()), o, out); }
	@SuppressWarnings("unchecked")
	public DynByteBuf writeObject(Object o, DynByteBuf buf) throws IOException { return writeObject((Serializer<Object>) SerializerFactory.SAFE_SERIALIZE_ONLY.serializer(o.getClass()), o, buf); }
	@SuppressWarnings("unchecked")
	public CharList writeObject(Object o, CharList sb) { return writeObject((Serializer<Object>) SerializerFactory.SAFE_SERIALIZE_ONLY.serializer(o.getClass()), o, sb); }
