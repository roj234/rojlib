	...
	private void asmStruct(final int fieldId, final ClassNode data, final FieldNode fn,
		...
		if (set == null) {
			if (unsafePut != null) {
				...
				cw.varStore(fType, 2);
				cw.field(GETSTATIC, "roj/reflect/Unsafe", "U", "Lroj/reflect/Unsafe;");
				cw.insn(ALOAD_3);
				cw.ldc(Unsafe.fieldOffset(unsafePut, fn.name()));
				cw.varLoad(fType, 2);
				cw.invokeItf("roj/reflect/Unsafe", "put"+fType.capitalized(), "(Ljava/lang/Object;J"+(fType.isPrimitive() ? fType.toDesc() : "Ljava/lang/Object;")+")V");
