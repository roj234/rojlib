...
public abstract class CEntry {
	...
	public final CEntry query(@Language("JSONPath") String jsonPath) { return update(jsonPath, 0, CNull.NULL); }
	@Contract("_, _, !null -> !null")
	public final CEntry update(@Language("JSONPath") String jsonPath,
