 ...
 */
public abstract class Node extends CEntry {
	// region XPath的子集
	...
	@Override public final CMap asMap() {return new CMap(attributesWritable());}
	@Override public final CList asList() {return new CList(childNodes());}
	...
	public Map<String, CEntry> attributesWritable() {return Collections.emptyMap();}
	// endregion
	// region children
	...
	public abstract void accept(CVisitor cc);
