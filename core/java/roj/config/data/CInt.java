 ...
 */
public final class CInt extends CEntry implements Comparable<CEntry> {
	public int value;
	public CInt() {}
	...
	public int compareTo(@NotNull CEntry o) {return o.mayCastTo(Type.INTEGER) ? Integer.compare(value, o.asInt()) : toString().compareTo(o.toString());}
}