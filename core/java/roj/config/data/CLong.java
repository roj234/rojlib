 ...
 */
public class CLong extends CEntry implements Comparable<CEntry> {
	public long value;
	public CLong() {}
	...
	public int compareTo(@NotNull CEntry o) {return o.mayCastTo(Type.LONG) ? Long.compare(value, o.asLong()) : toString().compareTo(o.toString());}
}