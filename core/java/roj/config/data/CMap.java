...
public class CMap extends CEntry {
	...
	@NotNull public CEntry get(String key) {return get(key, CNull.NULL);}
	@Nullable public final CEntry getNullable(String k) {return get(k,null);}
	@Contract("_,!null -> !null") public CEntry get(String k, CEntry def) {
