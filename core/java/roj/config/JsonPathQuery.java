...
public class JsonPathQuery implements ValueEmitter {
	 ...
	 * 和{@link ConfigValue#query(String)}格式相同，暂不支持""和通配符
	 * @param sql
	 * @param visitor
	 */
	public void query(String sql, ValueEmitter visitor) {
		var node = root;
	...
	public void emit(boolean b) {
		...
		if (visitor != null) visitor.emit(b);
	}
	@Override
	public void emit(int i) {
		if (visitor == null) nextVisitor();
		if (visitor != null) visitor.emit(i);
	}
	@Override
	...
	public void emit(String s) {
		if (visitor == null) nextVisitor();
		if (visitor != null) visitor.emit(s);
	}
	@Override
	public void emitNull() {
		if (visitor == null) nextVisitor();
		if (visitor != null) visitor.emitNull();
	}
