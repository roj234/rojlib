...
public abstract class SerializerFactory {
	...
	public static SerializerFactory getInstance(@MagicConstant(flags = {GENERATE, CHECK_INTERFACE, CHECK_PARENT, SERIALIZE_ONLY, PARSE_DYNAMIC, PREFER_DYNAMIC, OBJECT_POOL, SERIALIZE_PUBLIC_ONLY, SERIALIZE_PARENT, NO_SCHEMA}) int flag) {return getInstance0(flag);}
	private static SerializerFactory getInstance0(int flag) {return new SerializerFactoryImpl(flag, Reflection.getCallerClass(3, SerializerFactory.class).getClassLoader());}
	...
	private static final SerializerFactory POOLED = getInstance(GENERATE|PARSE_DYNAMIC|OBJECT_POOL|CHECK_INTERFACE|SERIALIZE_PARENT);
	public static SerializerFactory pooled() {return POOLED;}
