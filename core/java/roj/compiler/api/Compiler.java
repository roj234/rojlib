...
public interface Compiler {
	...
	//endregion
	//region 词法分析API
	int STATE_CLASS  = 1 << JavaTokenizer.STATE_CLASS;
	int STATE_MODULE = 1 << JavaTokenizer.STATE_MODULE;
	int STATE_EXPR   = 1 << JavaTokenizer.STATE_EXPR;
	int STATE_TYPE   = 1 << JavaTokenizer.STATE_TYPE;
	/**
	 * 创建具有指定分类的新词法标记。
	 *
	 ...
	 * @apiNote 该方法不适用于动态标记（如{@link Token#FLOAT}等字面量类型）
	...
	record OperatorContext(short symbol, IType leftType, IType rightType) { }
