...
public abstract class CompileUnit extends ClassNode implements ClassResource {
	 ...
	 * @return 有效的访问标志组合
	 */
	public final int readModifiers(JavaTokenizer wr, int mask) throws ParseException {
	 ...
	 * 解析类型
	 */
	protected final IType readType(JavaTokenizer wr, int flags) throws ParseException {
		Token w = wr.next();
	...
	protected final void genericDecl(JavaTokenizer wr) throws ParseException {
		var s = makeSignature();
