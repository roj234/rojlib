...
/*------   Version   ------*/
#define FL2_VERSION_NUMBER  10001
typedef unsigned (* FL2_versionNumber)();   /**< useful to check dll version */

#define FL2_VERSION_STRING #1.0.1
typedef const char* (* FL2_versionString)();

#define FL2_MAXTHREADS 200

/*======  Helper functions  ======*/
typedef size_t      (* FL2_compressBound)(size_t srcSize); /*!< maximum compressed size in worst case scenario */
typedef unsigned    (* FL2_isError)(size_t code);          /*!< tells if a `size_t` function result is an error code */
typedef unsigned    (* FL2_isTimedOut)(size_t code);       /*!< tells if a `size_t` function result is the timeout code */
typedef const char* (* FL2_getErrorName)(size_t code);     /*!< provides readable string from an error code */
typedef int         (* FL2_maxCLevel)();               /*!< maximum compression level available */
typedef int         (* FL2_maxHighCLevel)();           /*!< maximum compression level available in high mode */
...
typedef FL2_CStream* (* FL2_createCStream)();
typedef FL2_CStream* (* FL2_createCStreamMt)(unsigned nbThreads, int dualBuffer);
typedef void (* FL2_freeCStream)(FL2_CStream * fcs);
 ...
 *  level upon creation. */
typedef size_t (* FL2_initCStream)(FL2_CStream* fcs, int compressionLevel);
...
typedef size_t (* FL2_setCStreamTimeout)(FL2_CStream * fcs, unsigned timeout);
...
typedef size_t (* FL2_compressStream)(FL2_CStream* fcs, FL2_outBuffer *output, FL2_inBuffer* input);
...
typedef size_t (* FL2_copyCStreamOutput)(FL2_CStream* fcs, FL2_outBuffer *output);
...
typedef size_t (* FL2_getDictionaryBuffer)(FL2_CStream* fcs, FL2_dictBuffer* dict);
...
typedef size_t (* FL2_updateDictionary)(FL2_CStream* fcs, size_t addedSize);
...
typedef size_t (* FL2_getNextCompressedBuffer)(FL2_CStream* fcs, FL2_cBuffer* cbuf);
...
typedef unsigned long long (* FL2_getCStreamProgress)(const FL2_CStream * fcs, unsigned long long *outputSize);
...
typedef size_t (* FL2_waitCStream)(FL2_CStream * fcs);
...
typedef void (* FL2_cancelCStream)(FL2_CStream *fcs);

/*! FL2_remainingOutputSize() :
 *  The amount of compressed data remaining to be read from the CStream object. */
typedef size_t (* FL2_remainingOutputSize)(const FL2_CStream* fcs);
...
typedef size_t (* FL2_flushStream)(FL2_CStream* fcs, FL2_outBuffer *output);
 ...
 *  an error code. */
typedef size_t (* FL2_endStream)(FL2_CStream* fcs, FL2_outBuffer *output);
 ...
 *  The function will update both `pos` lz_fieldid.
...
typedef FL2_DStream* (* FL2_createDStream)();
typedef FL2_DStream* (* FL2_createDStreamMt)(unsigned nbThreads);
typedef size_t (* FL2_freeDStream)(FL2_DStream* fds);
...
typedef void (* FL2_setDStreamMemoryLimitMt)(FL2_DStream* fds, size_t limit);
...
typedef size_t (* FL2_setDStreamTimeout)(FL2_DStream * fds, unsigned timeout);
...
typedef size_t (* FL2_waitDStream)(FL2_DStream * fds);
...
typedef void (* FL2_cancelDStream)(FL2_DStream *fds);

/*! FL2_getDStreamProgress() :
 *  Returns the number of bytes decoded since the stream was initialized. */
typedef unsigned long long (* FL2_getDStreamProgress)(const FL2_DStream * fds);
...
typedef size_t (* FL2_initDStream)(FL2_DStream* fds);
typedef size_t (* FL2_initDStream_withProp)(FL2_DStream* fds, unsigned char prop);
...
typedef size_t (* FL2_decompressStream)(FL2_DStream* fds, FL2_outBuffer* output, FL2_inBuffer* input);
...
typedef size_t (* FL2_CStream_setParameter)(FL2_CStream* fcs, FL2_cParameter param, size_t value);
...
typedef size_t (* FL2_CStream_getParameter)(FL2_CStream* fcs, FL2_cParameter param);
...
typedef size_t (* FL2_getLevelParameters)(int compressionLevel, int high, FL2_compressionParameters *params);
...
typedef size_t (* FL2_estimateCStreamSize)(int compressionLevel, unsigned nbThreads, int dualBuffer); /*!< memory usage determined by level */
typedef size_t (* FL2_estimateCStreamSize_byParams)(const FL2_compressionParameters *params, unsigned nbThreads, int dualBuffer); /*!< memory usage determined by params */
typedef size_t (* FL2_estimateCStreamSize_usingCStream)(const FL2_CStream* fcs);   /*!< memory usage determined by settings */
...
typedef size_t (* FL2_getDictSizeFromProp)(unsigned char prop);
...
typedef size_t (* FL2_estimateDStreamSize)(size_t dictSize, unsigned nbThreads); /*!<  obtain dictSize from FL2_getDictSizeFromProp() */
