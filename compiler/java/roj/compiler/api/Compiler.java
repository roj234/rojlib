...
public interface Compiler {
	...
	//endregion
	//region 词法分析API
	int STATE_CLASS  = 1 << LavaTokenizer.STATE_CLASS;
	int STATE_MODULE = 1 << LavaTokenizer.STATE_MODULE;
	int STATE_EXPR   = 1 << LavaTokenizer.STATE_EXPR;
	int STATE_TYPE   = 1 << LavaTokenizer.STATE_TYPE;
	/**
	 * 创建具有指定分类的新词法标记。
	 *
