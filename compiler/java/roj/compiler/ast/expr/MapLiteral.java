...
final class MapLiteral extends Expr {
	...
	protected void write1(MethodWriter cw, @NotNull TypeCast.Cast cast) {
		...
		cw.clazz(NEW, "roj/collect/HashMap");
		cw.insn(DUP);
		cw.ldc(keys.size());
		...
		for (int i = 0; i < keys.size(); i++) {
			...
			cw.invoke(INVOKEVIRTUAL, "roj/collect/HashMap", "put", "(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;");
			cw.insn(POP);
		}
	}
