...
public interface LambdaCall {
	/**
	 *  metafactory前三个参数由VM提供，后面的参数由下面的三个arguments提供
	 ...
	 */
	LambdaCall INVOKE_DYNAMIC = (ctx, cw, lambdaOwner, lambdaMethod, lambdaActualArguments, capturedTypes, capturedTypesExpr, implementationOwner, implementation) -> {
		// 注入参数
	...
	LambdaCall ANONYMOUS_CLASS = (ctx, cw, lambdaOwner, lambdaMethod, lambdaActualArguments, capturedTypes, capturedTypesExpr, implementationOwner, implementation) -> {
	 ...
	 */
	void generate(CompileContext ctx, MethodWriter cw,
