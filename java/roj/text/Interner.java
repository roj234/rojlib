...
public final class Interner extends LFUCache<CharSequence,String> {
	...
	public static String intern(CharSequence input) {return instances.get().doIntern(input);}
	public static String intern(CharSequence input, int off, int len) {return instances.get().doIntern(input.subSequence(off, len));}
