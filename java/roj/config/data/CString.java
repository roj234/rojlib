...
public final class CString extends CEntry {
	...
	public boolean eqVal(CEntry o) { return o.toString().equals(value); }
	@Override
	...
	@Override
	public CharList toJSON(CharList sb, int depth) { return Tokenizer.addSlashes(sb.append('"'), value).append('"'); }
	@Override
	protected void toBinary(DynByteBuf w, VinaryParser struct) { w.put(Type.STRING.ordinal()).putVUIGB(value); }
	@Override
