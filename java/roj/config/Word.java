...
public class Word {
	 ...
	 * 复用对象
	 */
	public Word init(int type, int index, CharSequence word) {
	...
	public Word copy() { return new Word().init(type, pos, val.toString()); }

	public static Word timeWord(int type, int pos, long value, CharSequence represent) { return new L(type, pos, value, represent); }
	public static Word numberWord(int pos, int value, CharSequence represent) { return new I(pos, value, represent); }
	public static Word numberWord(int pos, long value, CharSequence represent) { return new L(pos, value, represent); }
	public static Word numberWord(int pos, float value, CharSequence represent) { return new F(pos, value, represent); }
	public static Word numberWord(int pos, double value, CharSequence represent) { return new D(pos, value, represent); }
	private static class Num extends Word {
		public final Word init(int type, int index, CharSequence word) { throw new UnsupportedOperationException("数字word不可变"); }
