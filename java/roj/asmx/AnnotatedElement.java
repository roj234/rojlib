...
public abstract sealed class AnnotatedElement permits AnnotatedElement.Type, AnnotatedElement.Node {
	...
	public static final class Node extends AnnotatedElement {
		...
		public Node(Type parent, CNode node) {
			this.parent = parent;
			this.node = node;
		}
