...
public class ObfuscatorUI extends JFrame {
	...
	public ObfuscatorUI() {
		...
		uIFlatControl.addActionListener((e) -> {
			boolean b = uIFlatControl.isSelected();
			if (!b) uiDeadCode.setSelected(false);
			uiDeadCode.setEnabled(b);
		});
	...
	private void checkExclusion(ConstantData data, int flag) {
		...
		for (int j = 0; j < methods.size(); j++) {
			...
			if ((flag&32) != 0 && (mn.modifier()& Opcodes.ACC_NATIVE) != 0) {
	...
	private void initComponents() {
		...
		uiAddSynthetic = new JCheckBox();
		uIFlatControl = new JCheckBox();
		uiSeed = new JSpinner();
		...
		uiDeadCode = new JCheckBox();
		uiMergeClass = new JCheckBox();
		uiObfuscateNum = new JCheckBox();
		uiWhitespace = new JCheckBox();
		...
		//======== this ========
		setTitle("Roj234 Obfuscator 3.0 - WIP");
		setResizable(false);
		...
		//---- uiAddSynthetic ----
		uiAddSynthetic.setText("synthetic");
		contentPane.add(uiAddSynthetic);
		uiAddSynthetic.setBounds(new Rectangle(new Point(360, 90), uiAddSynthetic.getPreferredSize()));

		//---- uIFlatControl ----
		uIFlatControl.setText("\u6d41\u7a0b\u5c55\u5e73");
		contentPane.add(uIFlatControl);
		uIFlatControl.setBounds(new Rectangle(new Point(360, 50), uIFlatControl.getPreferredSize()));
		...
		//---- uiDeadCode ----
		uiDeadCode.setText("\u6b7b\u4ee3\u7801");
		uiDeadCode.setEnabled(false);
		contentPane.add(uiDeadCode);
		uiDeadCode.setBounds(new Rectangle(new Point(455, 50), uiDeadCode.getPreferredSize()));

		//---- uiMergeClass ----
		uiMergeClass.setText("\u7c7b\u805a\u2122");
		contentPane.add(uiMergeClass);
		uiMergeClass.setBounds(new Rectangle(new Point(455, 90), uiMergeClass.getPreferredSize()));

		//---- uiObfuscateNum ----
		uiObfuscateNum.setText("\u6570\u5b57\u6df7\u6dc6");
		contentPane.add(uiObfuscateNum);
		uiObfuscateNum.setBounds(new Rectangle(new Point(360, 70), uiObfuscateNum.getPreferredSize()));

		//---- uiWhitespace ----
		uiWhitespace.setText("\u7a7a\u767d\u5b57\u7b26");
		contentPane.add(uiWhitespace);
		uiWhitespace.setBounds(new Rectangle(new Point(455, 70), uiWhitespace.getPreferredSize()));

		//---- uiKeepLines ----
		uiKeepLines.setText("\u4fdd\u7559\u884c\u53f7");
		contentPane.add(uiKeepLines);
		uiKeepLines.setBounds(new Rectangle(new Point(455, 30), uiKeepLines.getPreferredSize()));
		...
		//---- uiRandomReflect ----
		uiRandomReflect.setText("\u53cd\u5c04\u8f6c\u6362");
		contentPane.add(uiRandomReflect);
		uiRandomReflect.setBounds(new Rectangle(new Point(360, 110), uiRandomReflect.getPreferredSize()));
	...
	private JCheckBox uiAddSynthetic;
	private JCheckBox uIFlatControl;
	private JSpinner uiSeed;
	private JComboBox<String> uiSyntheic;
	private JCheckBox uiDelAttr;
	private JCheckBox uiDeadCode;
	private JCheckBox uiMergeClass;
	private JCheckBox uiObfuscateNum;
	private JCheckBox uiWhitespace;
	...
	private JCheckBox uiRandomReflect;
