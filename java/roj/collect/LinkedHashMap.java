...
public class LinkedHashMap<K, V> extends HashMap<K, V> {
    public static class LinkedEntry<K, V> extends HashMap.Entry<K, V> {
	...
	public LinkedHashMap() {this(16);}
	public LinkedHashMap(int size) {super(size);}
	public LinkedHashMap(Map<K, V> map) {putAll(map);}
	...
	public final class EntryItr extends AbstractIterator<Entry<K, V>> {
		...
		protected void remove(Entry<K, V> obj) {
			LinkedHashMap.this.remove(obj.key);}
	}
