...
public final class Lavac extends LavaCompiler {
	...
	public static final String VERSION = "1.0.3-alpha (compiled on "+getCompileTime()+")";
	...
	public static void main(String[] args) throws IOException, ReflectiveOperationException {
		...
		// InitDefaultPlugins Requires CompileContext
		...
		if (ok) {
			...
			if (bin == null) {
				try (var archive = new ZipFile(dst)) {
					...
					Class.forName("Test", true, scl).getDeclaredMethod("main", String[].class).invoke(null, (Object) new String[0]);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
