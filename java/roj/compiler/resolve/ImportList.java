...
public final class ImportList {
	...
	private void resolveImport(CompileContext ctx, HashMap<String, Object> importList) {
		var gc = ctx.compiler;
	 ...
	 */
	public ClassNode resolveField(CompileContext ctx, String name, List<FieldNode> out2) {
	 ...
	 */
	public ClassNode resolveMethod(CompileContext ctx, String name) {
