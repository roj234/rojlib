...
public interface DynamicResolver {
	/**
	 * 触发时机: {@link roj.compiler.context.GlobalContext#getClassInfo(CharSequence)}未找到name定义的类 <br>
	 * 用途: 也许可以按照命名规则生成某些类？
	 */
	@Nullable IClass resolveClass(CharSequence name);
	/**
	 ...
	 */
	default void classResolved(IClass info) {}
	/**
