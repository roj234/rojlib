...
final class Asn1Tokenizer extends Tokenizer {
	static final String[] keywords = TextUtil.split1(
		"INTEGER,BIT STRING,OCTET STRING,NULL," +
		"UTF8 STRING,PRINTABLE STRING,IA5 STRING,UTCTime,GeneralizedTime," +
		"OBJECT IDENTIFIER,ANY,BOOLEAN," +
		"SET OF,SEQUENCE OF," +
		"SEQUENCE,SET,CHOICE," +
		"OPTIONAL,IMPLICIT,EXPLICIT,DEFINED BY", ',');
	static final short
	...
	static {
		addKeywords(ASN1_TOKEN, 10, keywords);
		addSymbols(ASN1_TOKEN, ASN1_LEND, 31, operators);
