 ...
 */
public class FileDataStorage extends DataStorage implements BiConsumer<String,Map<String,Object>> {
	...
	public FileDataStorage(File baseDir, int concurrency, int LRUSizePerConcurrency) {
	...
	public DataStorage saveOnClose() {
