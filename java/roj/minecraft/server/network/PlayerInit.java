...
import static roj.minecraft.server.data.Enums.GAMEMODE_SURVIVAL;
...
public class PlayerInit implements ChannelHandler {
	private static final byte[] NBT = Utils.constantize("META-INF/minecraft/DynamicRegistry.json");
