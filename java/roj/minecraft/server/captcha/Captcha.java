package roj.minecraft.server.captcha;
...
import roj.minecraft.server.data.Enums;
import roj.minecraft.server.data.Item;
import roj.minecraft.server.data.ItemStack;
import roj.minecraft.server.data.PlayerEntity;
import roj.minecraft.server.data.world.World;
import roj.minecraft.server.network.CommandTree;
import roj.minecraft.server.network.ConstantPacket;
import roj.minecraft.server.network.Packet;
import roj.minecraft.server.network.PlayerConnection;
...
public final class Captcha implements ChannelHandler {
	...
	public void channelOpened(ChannelCtx ctx) throws IOException {
		...
		for (String line : LineReader.create(template.replace(map, new CharList()).toString())) {
