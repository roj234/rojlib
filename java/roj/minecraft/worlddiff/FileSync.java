...
public class FileSync implements ChannelHandler {
	...
	public static void main(String[] args) throws Exception {
		...
		if (config.getBool("server")) {
			...
			InetSocketAddress addr = NetUtil.parseListeningAddress(config.getString("address"));
			...
			Client.allow_extension = config.getOrCreateList("allow_extensions").toStringSet();
			if (Client.allow_extension.isEmpty()) {
				Client.allow_extension = new MyHashSet<>("jar", "zip", "zs", "toml", "json", "yml", "yaml", "cfg", "txt");
			}

			InetSocketAddress addr = NetUtil.parseConnectAddress(config.getString("address"));
