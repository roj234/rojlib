...
public class RoArchive implements ArchiveFile {
	Source r, fpRead;
	private static final long FPREAD_OFFSET = Unaligned.fieldOffset(RoArchive.class, "fpRead");
	...
	public InputStream getStream(RoarEntry entry) throws IOException {
		...
		InputStream in = new SourceInputStream.Shared(src, entry.compressedSize, this, FPREAD_OFFSET);
